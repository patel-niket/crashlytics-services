...
describe Service::GitHubEnterprise do
  let(:config) do
    {
  ...
  it 'has a title' do
    expect(Service::GitHubEnterprise.title).to eq('GitHub Enterprise')
  end

  describe 'schema and display configuration' do
    subject { Service::GitHubEnterprise }
    ...
    it { is_expected.to include_page 'API Endpoint', [:api_endpoint] }
  end

  describe :receive_verification do
    it :success do
      service = Service::GitHubEnterprise.new('verification', {})
      expect(service).to receive(:github_repo).with('foo_access_token', 'https://github.company.com/api/v3/','crashlytics/sample-project')
    ...
    it :failure do
      service = Service::GitHubEnterprise.new('verification', {})
      expect(service).to receive(:github_repo).with('foo_access_token', 'https://github.company.com/api/v3/','crashlytics/sample-project') { raise }
  ...
  describe :receive_issue_impact_change do
    ...
    it 'should create a new GitHub issue' do
      service = Service::GitHubEnterprise.new('issue_impact_change', {})
